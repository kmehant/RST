...
class Guidance(types.ModuleType):
    scores_return = None
    def __call__(self, template, llm=None, cache_seed=0, logprobs=None, silent=None, async_mode=False, stream=None, caching=None, await_missing=False, module=None, options=None, schema=None, task_config=None, **kwargs):
        global module_name
