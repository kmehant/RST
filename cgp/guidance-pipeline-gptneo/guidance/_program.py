...
class Program:
    ...
    def __call__(self, **kwargs):
        ...
        if(library._select.interrupt):
            library._select.interrupt = 0  #reset the interrupt
            global options_available
            new_program_1 = new_program(token_healing=False, options_available=guidance.options_available,unique=[1],id=1)   #start execution with new dynamic template
            return new_program_1
        return new_program
