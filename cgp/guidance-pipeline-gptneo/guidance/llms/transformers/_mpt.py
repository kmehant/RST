    ...
    def _model_and_tokenizer(self, model, tokenizer, **kwargs):
        ...
        if isinstance(model, str):
            ...
            if tokenizer is None:
                tokenizer = transformers.AutoTokenizer.from_pretrained("dccstor/ai4code-ansible/shared/model_delivery/wisdom-ansible-v9/model_20230326-135203/checkpoint", **kwargs)
            ...
            config = transformers.AutoConfig.from_pretrained(
                "/dccstor/ai4code-ansible/shared/model_delivery/wisdom-ansible-v9/model_20230326-135203/checkpoint",
                trust_remote_code=True
            )
