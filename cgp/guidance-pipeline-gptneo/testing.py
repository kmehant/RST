...
for i in tqdm(range(0,len(ir_data_df))):
  ...
  try:
      ...
      obj = nl2structure(schema = "/dccstor/rhassistant/mehant/paper/guidance/guidance-guidanceV2/data_with_ft.jsonl", reference_module = module_list, model_class="bigcode/starcoderbase-1b", prompt=prompt, task="ansible_yaml", template=False)
      pred_structure = obj()
      ...
      ir_data_jsonl[i]["output"] = str(pred_structure)
